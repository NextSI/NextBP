...
/**
 * pdfjsVersion = 5.4.226
 * pdfjsBuild = 05af4ff78
 */
/******/ // The require scope
...
{
  const HOSTED_VIEWER_ORIGINS = new Set(["null", "http://localhost:*", "https://localhost:*", "http://127.0.0.1:*", "https://127.0.0.1:*"]);
